...
# ── Personalized Investment Advisor agents ─────────────────
from src.agents.fundamental_analyst import fundamental_analyst_agent as new_fundamental_analyst_agent
from src.agents.technical_analyst import technical_analyst_agent as new_technical_analyst_agent
...
ANALYST_CONFIG = {
    ...
    "personal_financial_advisor": {
        "display_name": "Personal Financial Advisor",
        "description": "Your Personal Advisor",
        "investing_style": "Analyzes user profiles, risk appetite, goals, and conversation history to produce personalized investment context that guides all other agents.",
        "agent_func": personal_financial_advisor_agent,
        "type": "advisor",
        "order": 19,
    },
    "fundamental_analyst_v2": {
        "display_name": "Fundamental Analyst v2",
        "description": "Advanced Financial Analyst",
        "investing_style": "Evaluates profitability, growth, financial health, and valuation using multi-period data and LLM-powered reasoning.",
        "agent_func": new_fundamental_analyst_agent,
        "type": "analyst",
        "order": 20,
    },
    "technical_analyst_v2": {
        "display_name": "Technical Analyst v2",
        "description": "Advanced Chart Analyst",
        "investing_style": "Analyzes trends, momentum, volume, and volatility using SMA crossovers, RSI, and price action.",
        "agent_func": new_technical_analyst_agent,
        "type": "analyst",
        "order": 21,
    },
}
...
# Default analysts for the personalized recommendation workflow (modern agents only)
DEFAULT_PERSONALIZED_ANALYSTS = [
    "fundamental_analyst_v2",
    "technical_analyst_v2",
    "news_sentiment_analyst",
    "sentiment_analyst",
